...
from configs.settings import COMMON_PREDICTORS, OVER25_PREDICTORS
...
def over25_predictions(user_token, train_matches, test_matches, compe_data, do_grid_search=False, is_random_search=False, update_model=False):

    target = 'over25_target'
    PREDICTORS = OVER25_PREDICTORS
