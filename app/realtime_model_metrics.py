...
class RealtimeModelMetrics:
    def __init__(self, user_token, target, prediction_types):
    ...
    def load_metrics(self):
        ...
        for prediction_type in self.prediction_types:
            train(self.user_token, target=self.target,
                  prediction_type=prediction_type, hyperparameters=self.hyperparameters)
